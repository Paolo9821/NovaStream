...
const it = {
  ...
  "pl.keyHelp": "6 caratteri mostrati nello stesso riquadro. Serve a far sì che solo chi ha il dispositivo in mano possa modificarlo.",
  "pl.open": "Apri",
  "pl.opening": "Apro il dispositivo…",
  "pl.errInvalid": "Controlla l'identificativo: deve essere quello mostrato dall'app.",
  "pl.errOpen": "Dispositivo o chiave non corretti. Se non hai mai aperto l'app dopo l'aggiornamento 1.2.9, aprila una volta e riprova.",
...
const en: Dictionary = {
  ...
  "pl.key": "Device key",
  "pl.keyHelp": "6 characters shown in the same card. It makes sure only whoever has the device in hand can change it.",
  "pl.open": "Open",
  "pl.opening": "Opening the device…",
  "pl.errInvalid": "Check the identifier: it must be the one shown by the app.",
  "pl.errOpen": "Wrong device or key. If you haven't opened the app since updating to 1.2.9, open it once and try again.",
...
const es: Dictionary = {
  ...
  "pl.keyHelp": "6 caracteres que aparecen en el mismo recuadro. Así solo quien tiene el dispositivo puede modificarlo.",
  "pl.open": "Abrir",
  "pl.opening": "Abriendo el dispositivo…",
  "pl.errInvalid": "Revisa el identificador: debe ser el que muestra la app.",
  "pl.errOpen": "Dispositivo o clave incorrectos. Si no has abierto la app desde la actualización 1.2.9, ábrela una vez y vuelve a intentarlo.",
...
const fr: Dictionary = {
  ...
  "pl.keyHelp": "6 caractères affichés dans le même encadré. Seule la personne qui a l'appareil en main peut ainsi le modifier.",
  "pl.open": "Ouvrir",
  "pl.opening": "Ouverture de l'appareil…",
  "pl.errInvalid": "Vérifiez l'identifiant : ce doit être celui affiché par l'app.",
  "pl.errOpen": "Appareil ou clé incorrects. Si vous n'avez pas ouvert l'app depuis la mise à jour 1.2.9, ouvrez-la une fois puis réessayez.",
...
const de: Dictionary = {
  ...
  "pl.keyHelp": "6 Zeichen im selben Feld. So kann nur ändern, wer das Gerät in der Hand hat.",
  "pl.open": "Öffnen",
  "pl.opening": "Gerät wird geöffnet…",
  "pl.errInvalid": "Prüfe die Kennung: Es muss die in der App angezeigte sein.",
  "pl.errOpen": "Gerät oder Schlüssel falsch. Falls du die App seit dem Update auf 1.2.9 nicht geöffnet hast, öffne sie einmal und versuche es erneut.",
...
const pt: Dictionary = {
  ...
  "pl.keyHelp": "6 caracteres mostrados no mesmo quadro. Assim só quem tem o dispositivo na mão o pode alterar.",
  "pl.open": "Abrir",
  "pl.opening": "A abrir o dispositivo…",
  "pl.errInvalid": "Verifique o identificador: tem de ser o mostrado pela app.",
  "pl.errOpen": "Dispositivo ou chave incorretos. Se não abriu a app desde a atualização 1.2.9, abra-a uma vez e tente de novo.",
...
const ro: Dictionary = {
  ...
  "pl.keyHelp": "6 caractere afișate în aceeași casetă. Așa doar cine are dispozitivul în mână îl poate modifica.",
  "pl.open": "Deschide",
  "pl.opening": "Se deschide dispozitivul…",
  "pl.errInvalid": "Verifică identificatorul: trebuie să fie cel afișat de aplicație.",
  "pl.errOpen": "Dispozitiv sau cheie greșite. Dacă nu ai deschis aplicația de la actualizarea 1.2.9, deschide-o o dată și încearcă din nou.",
...
const tr: Dictionary = {
  ...
  "pl.keyHelp": "Aynı kutuda gösterilen 6 karakter. Böylece cihazı yalnızca elinde tutan kişi değiştirebilir.",
  "pl.open": "Aç",
  "pl.opening": "Cihaz açılıyor…",
  "pl.errInvalid": "Kimliği kontrol et: uygulamada gösterilenle aynı olmalı.",
  "pl.errOpen": "Cihaz veya anahtar hatalı. 1.2.9 güncellemesinden beri uygulamayı açmadıysan bir kez aç ve tekrar dene.",
